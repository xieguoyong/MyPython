...
class BeautifulPicture():
    ...
    def __init__(self):  #类的初始化操作
        self.headers = {"user-agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.98 Safari/537.36"}  #给请求指定一个请求头来模拟chrome浏览器
        self.web_url = 'https://unsplash.com'  #要访问的网页地址
        self.folder_path = "E:\PycharmProjects\MyPython\save_pic"  #设置图片要存放的文件目录
